    ...
    <div className="w-full max-w-[1360px] h-[458px] flex flex-col gap-8 opacity-100">
      ...
      <div className="w-full h-10 flex items-center justify-between gap-2.5 opacity-100">
        ...
        <button
          ...
          className="flex-shrink-0 w-[91px] h-[26px] rounded-[6px] flex items-center justify-center gap-[14px] opacity-100 font-['Inter'] font-medium text-base leading-[26px] tracking-[0%] text-center text-[#F29145] hover:text-[#E08034] transition-colors"
        >
          See All
