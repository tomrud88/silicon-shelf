    ...
    <div>
      ...
      <div className="max-w-[1440px] w-full min-h-[424px] gap-12 opacity-100 p-10 mx-auto flex items-start">
        ...
        <div className="w-[320px] min-h-[194px] rounded-[6px] gap-6 opacity-100 border p-6 bg-[#262626] border-[#383B42] flex flex-col">
          ...
          {/* Logout Text */}
          <span className="font-['Inter'] font-medium text-base leading-[26px] tracking-[0%] align-middle text-[var(--text-secondary)]">
            Logout
          </span>
        </div>
          ...
          <div className="w-[992px] min-h-[272px] gap-4 opacity-100 flex flex-col">
            {isLoading ? (
              ...
              orders.map((order) => (
                <div
                  key={order.id}
                  className="w-[992px] h-[128px] rounded-[6px] gap-4 opacity-100 border p-4 bg-[#262626] border-[#383B42] flex items-start"
                >
                  {/* Icon Container */}
